...
/// 
/// \param Z, type of integer, Z stands for Zahlen, number.
/// \param n upper limit on the primes (i.e., we find all primes less than or
///   equal to n).
/// \param primes array to hold the table of primes.
/// \return the number of primes we found.
//------------------------------------------------------------------------------
template <typename Z>
Z sieve(const std::size_t n, std::vector<Z> primes);
