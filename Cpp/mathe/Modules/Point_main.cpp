...
int main()
{
  ...
  /***************************************************************************/
  /** @ref pp. 114 Exercise 6.6 of Scheinerman (2006) */
  /***************************************************************************/
  Point P(4, 5);
  std::cout << "The point P after translation : " << P.translate(1,2) << '\n';

  /***************************************************************************/
  /** @ref pp. 114 Exercise 6.7 of Scheinerman (2006) */
  /***************************************************************************/
  Point P1(3, 5);
  (P1.translate(1,2)).translate(10, 10);
