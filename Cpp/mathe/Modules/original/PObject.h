 ...
 * @brief  : Program 10.11: Header file for the PObject class (version 2)
 * @ref    : pp. 202 Sec. 10.11 Header file for the PObject class Ch. 10 The Projective Plane; Edward Scheinerman, C++ for Mathematicians: An Introduction for Students and Professionals. Taylor & Francis Group, 2006. 
 * 
...
constexpr const double default_tolerance {1e-12};
