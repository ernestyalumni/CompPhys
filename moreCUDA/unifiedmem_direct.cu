/**
 * @file   : unifiedmem_direct.cu
 * @brief  : Simple program written with benefit of unified memory, with 
 *			: GPU-declared __managed__ variable direct reference
...
/* 
 * COMPILATION TIP
 * nvcc unifiedmem_direct.cu -o unifiedmem_direct.exe
 * 
 * */
#include <stdio.h> 
